...
const PromotionLine = () => {
  ...
  const onClickHandleBack = () => {
    window.location.href = "http://54.169.2.153:3000/cineza/admin/promotions";
  }
    ...
    const getAllPromotionLine = async () => {
      try {
        ...
        const response = await axios.get(
          `http://54.169.2.153:9000/cineza/api/v1/promotion-line/get-all-by-header/${codePromotionURI}`
        );
