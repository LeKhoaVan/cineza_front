...
const RapDetail = ({ codeRapBy, onClickHandleClose, addBtn }) => {
    ...
    if (codeRap != null) {
      try {
        const result = await axios.get(
          `http://47.128.146.135:9000/cineza/api/v1/room/get-all-by-code/${codeRap}`
        );
  ...
  useEffect(() => {
    ...
    const getRap = async () => {
      const result = await axios.get(
        `http://47.128.146.135:9000/cineza/api/v1/rap/get-by-code/${codeRapBy}`
      );
      if (result.status === 200) {
    ...
    const getAllCountry = async () => {
      try {
        const allWard = await axios.get(
          `http://47.128.146.135:9000/cineza/api/v1/address/get-by-level?levelAddress=XA/PHUONG`
        );
    ...
    if (countryId != "") {
      const getCity = async () => {
        const response = await axios.get(
          `http://47.128.146.135:9000/cineza/api/v1/address/get-by-parent/${countryId}`
        );
  ...
  useEffect(() => {
    if (cityId != "") {
      const getDistrict = async () => {
        const response = await axios.get(
          `http://47.128.146.135:9000/cineza/api/v1/address/get-by-parent/${cityId}`
        );
        if (response.status == 200) {
  ...
  useEffect(() => {
    if (districtId != "") {
      const getDistrict = async () => {
        const response = await axios.get(
          `http://47.128.146.135:9000/cineza/api/v1/address/get-by-parent/${districtId}`
        );
        if (response.status == 200) {
  ...
  const getRooms = async () => {
    if (codeRapBy != null) {
      try {
        const result = await axios.get(
          `http://47.128.146.135:9000/cineza/api/v1/room/get-all-by-code/${codeRapBy}`
        );
        if (result.status === 200) {
          setRooms(result.data);
          // console.log(result.data);
      ...
      try {
        if (editCode) {
          const response = await axios.post(
            `http://47.128.146.135:9000/cineza/api/v1/rap/create`,
            rap
          );
          ...
          const getShow = await axios.get(
            `http://47.128.146.135:9000/cineza/api/v1/show/get-all-by-rap/${code}`
          );
          ...
          if (newArray.length === 0) {
            const response = await axios.put(
              `http://47.128.146.135:9000/cineza/api/v1/rap/put/` + code,
              rap
            );
            if (response.status === 200) {
