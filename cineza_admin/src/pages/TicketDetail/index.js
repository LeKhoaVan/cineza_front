    ...
    try {
      ...
      if (editCode) {
        const response = await axios.post(
          `http://54.169.84.199:9000/cineza/api/v1/ticket/create`,
          ticket
        );
      ...
      //     `http://54.169.84.199:9000/cineza/api/v1/ticket/put/` + code,
      //     showTime
      //   );
    ...
    const getAllShowing = async () => {
      try {
        const allShowing = await axios.get(
          `http://54.169.84.199:9000/cineza/api/v1/show/get-all`
        );
    ...
    const getAllSeat = async () => {
      try {
        const allSeat = await axios.get(
          `http://54.169.84.199:9000/cineza/api/v1/seat/get-all`
        );
    ...
    const getData = async () => {
      try {
        const result = await axios.get(
          "http://54.169.84.199:9000/cineza/api/v1/value/user/get-all"
        );
