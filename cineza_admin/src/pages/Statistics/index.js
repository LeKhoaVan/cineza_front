...
function Statistics() {
    ...
    useEffect(() => {
        const statisticsValue = async () => {
            ...
            const dataStatistics = await axios.get(`http://47.128.146.135:9000/cineza/api/v1/statistics/year?year=${yearData}&month=${month}`)
    ...
    useEffect(() => {
        const statisticsTicket = async () => {
            ...
            const totalTicket = await axios.get(`http://47.128.146.135:9000/cineza/api/v1/statistics/get-total-ticket?year=${yearData}&month=${month}`)
            ...
            const dataStatistics = await axios.get(`http://47.128.146.135:9000/cineza/api/v1/statistics/top-5-movie?year=${yearData}&month=${month}`)
            if (dataStatistics.status === 200) {
                const newData = {
                    labels: dataStatistics.data.map(value => {
